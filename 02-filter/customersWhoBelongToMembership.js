...
/**
 * Filters the customers who belong to a membership.
 *
 * @param {Array} customersList - The array of customer objects.
...
export function customersWhoBelongToMembership(customersList) {
    return customersList.filter((customer) => customer.isMember);
}
